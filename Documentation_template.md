...
> Use [`docs/system_architecture.md`](docs/system_architecture.md) as the implementation
...
The pipeline follows [`docs/system_architecture.md`](docs/system_architecture.md): Stage 0 normalization, Stage 1
...
stage contracts and stop rules are in [`docs/system_architecture.md`](docs/system_architecture.md).
