...
[`docs/02_system_architecture.md`](docs/02_system_architecture.md). The BGE-M3 module README
documents the implemented Stage 2 feature components; the remaining stages
