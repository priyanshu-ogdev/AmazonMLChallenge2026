...
| LoRA rank as a structural regularizer | See "LoRA rank and layer coverage" below | Same source, plus the OOD-generalization evidence in `citations.md` |
