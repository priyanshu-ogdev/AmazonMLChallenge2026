...
|---|---|---|
| [**`system_architecture.md`**](system_architecture.md) | **Master System Architecture & Execution Contract** | The authoritative blueprint: decision summaries, evidence policy, BGE-M3 LoRA configuration contract, Qwen auxiliary ablation protocol, LightGBM/XGBoost feature budget, and singleton decision policy. |
